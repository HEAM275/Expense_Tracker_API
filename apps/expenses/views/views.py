...
class ExpenseViewSet(BaseModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: oa.Response(
                description="List of expenses", schema=ExpenseListSerializer(many=True)
            ),
            403: oa.Response(
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: oa.Response(
                description="Expense details", schema=ExpenseListSerializer
            ),
            403: oa.Response(
                description="Forbidden",
                schema=oa.Schema(
    ...
    @swagger_auto_schema(
        ...
        responses={
            201: oa.Response(
                description="Expense created successfully", schema=ExpenseListSerializer
            ),
            400: oa.Response(
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(
                {"message": _("Expense created successfully"), "data": serializer.data},
                status=status.HTTP_201_CREATED,
            )
        return Response(
            {"message": _("Expense could not be created"), "errors": serializer.errors},
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: oa.Response(
                description="Expense updated successfully", schema=ExpenseListSerializer
            ),
            400: oa.Response(
                description="Bad request",
                schema=oa.Schema(
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(
                {"message": _("Expense updated successfully"), "data": serializer.data},
                status=status.HTTP_200_OK,
            )

        return Response(
            {"message": _("Expense could not be updated"), "errors": serializer.errors},
            status=status.HTTP_400_BAD_REQUEST,
        )
    ...
    @swagger_auto_schema(
        ...
        responses={
            204: oa.Response(description="Expense deleted successfully"),
            403: oa.Response(
                description="Forbidden",
                schema=oa.Schema(
                    type=oa.TYPE_OBJECT,
